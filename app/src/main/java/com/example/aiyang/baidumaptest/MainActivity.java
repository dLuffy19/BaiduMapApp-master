package com.example.aiyang.baidumaptest;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (mDistance <= DISTANCE) {
                //显示文字
                setTextOption(mDestinationPoint, "您已在教室范围内", "#7ED321");
                //目的地图标
                ...
                setTextOption(LocationPoint, "您不在教室范围之内", "#FF6C6C");
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.arriver_bt) {
            ...
            if (mDistance <= DISTANCE) {
                ...
                Toast.makeText(this, "签到失败，您不在上课地点", Toast.LENGTH_SHORT).show();
            }
